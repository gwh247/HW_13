...
class PizzaGui:
    def __init__(self):
        ...
        self.name_label = tkinter.Label(self.name_frame,text ='Please enter your name: ', font=('Cominc Sans',8, 'bold'))
    ...
    def total_cost(self):
        ...
        tkinter.messagebox.showinfo('Total', "thank you: " + 'name ' +"your total is " + str(total))
        tkinter.mainloop()
